...
CREATE TABLE IF NOT EXISTS {SCHEMA_NAME}.{TABLE_NAME} (
    ...
    ShortName STRING,           -- Short name used for logistics and delivery
...
CREATE TABLE IF NOT EXISTS {SCHEMA_NAME}.{TABLE_NAME} (
    ...
    WarehouseID STRING,         -- Foreign key to Warehouses.WarehouseID
...
CREATE TABLE IF NOT EXISTS {SCHEMA_NAME}.{TABLE_NAME} (
    ...
    ProductID STRING NOT NULL,  -- Links to existing Product table
    WarehouseID STRING,
    ProductName STRING,         -- Denormalized for usability
