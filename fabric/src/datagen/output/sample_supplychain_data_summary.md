...
**Duration**: 303 days  
**Integration**: Connected to 52,531 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 5,581
...
- **Purchase Orders**: 116 procurement orders  
- **PO Line Items**: 334 order details
...
- **Purchase Orders**: 116 orders spanning 90-day historical period
...
- `PurchaseOrders.csv` - 116 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 334 line items with specifications
...
*Generation Parameters: 116 orders, 4545 transactions, 15 events*  
